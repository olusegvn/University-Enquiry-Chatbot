...
course_bank = {
    'Computer Science': ['computers', 'programming', 'electronics', 'machine learning',
                         ...
                         'building'],
    'Arts': ['drawing', 'painting', 'art', 'design', 'sketching', 'cooking', 'food', 'nutrition', 'animals',
             'treat', 'vetenary', 'heal', 'treat', 'help', 'medicine', 'drugs', 'biology',
             'chemistry', 'biology', 'drugs', 'biochemistry',
             'english', 'statistics', 'budgeting', 'accounting', 'finance', 'reading', 'languages', 'writing',
             'speaking', 'casting', 'music', 'listen', 'singing', 'beats', 'trance', 'human', 'human behaviour',
             'animal behaviour', 'humans think', 'behaviour', 'industry', 'chemistry', 'manufacturing', 'mechanics',
             'physics', 'engineering', 'industry', 'physics', 'manufacturing'],
    'Food and Nutrition': ['cooking', 'food', 'nutrition'],
    'Vetenary science': ['animals', 'treat', 'vetenary'],
    'Medicine': ['heal', 'treat', 'help', 'medicine', 'drugs', 'biology'],
    'biochemistry': ['chemistry', 'biology', 'drugs', 'biochemistry'],
    'english': ['english', 'statistics', 'budgeting', 'accounting', 'finance'],
    'Accounting and Finance': ['statistics', 'budgeting', 'accounting', 'finance'],
    'linguistics': ['reading', 'languages', 'writing', 'speaking'],
    'Mass communication': ['casting', 'reading', 'speaking'],
    'Music': ['music', 'listen', 'singing', 'beats', 'trance'],
    'engineering': ['mechanics', 'physics', 'engineering'],
    'Industrial Physics': [],
    'industrial chemistry': ['industry', 'chemistry', 'manufacturing'],
    'psychology': ['humans think', 'behaviour'],
    'Philosophy': ['human']
}
